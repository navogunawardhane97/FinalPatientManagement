...
public class PatientAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = patientObj.insertPatient(request.getParameter("nic"), request.getParameter("name"), 
				request.getParameter("age"), request.getParameter("address"), 
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String result = patientObj.deletePatient(param.get("patientID").toString());
